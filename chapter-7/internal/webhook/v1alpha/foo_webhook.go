...
// +kubebuilder:webhook:path=/mutate-samplecontroller-io-io-v1alpha-foo,mutating=true,failurePolicy=fail,sideEffects=None,groups=samplecontroller.io.io,resources=foos,verbs=create;update,versions=v1alpha,name=mfoo-v1alpha.kb.io,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-samplecontroller-io-io-v1alpha-foo,mutating=false,failurePolicy=fail,sideEffects=None,groups=samplecontroller.io.io,resources=foos,verbs=create;update,versions=v1alpha,name=vfoo-v1alpha.kb.io,admissionReviewVersions=v1
